...
var TextureAtlasHelper = require("../com/arkadium/core/assets/TextureAtlasHelper");
...
Preloader.prototype = {
    ...
    preload: function () {
        ...
        this.game.gameContext["TAH"] = this._tah;
        ...
        var atlasImageUrl = 'assets/images/'+GameSettings.assetScale+'x/'+GameSettings.gameAtlas2+'.png';
        var atlasJsonUrl = 'assets/images/'+GameSettings.assetScale+'x/'+GameSettings.gameAtlas2+'.json';
        this.load.atlas(GameSettings.gameAtlas2, atlasImageUrl, atlasJsonUrl);
        this.game.load.json(GameSettings.gameAtlas2, atlasJsonUrl);
        this._tah.registerAtlas(GameSettings.gameAtlas2, atlasImageUrl, atlasJsonUrl);

        this.game.load.json('inGameUI', 'assets/gui/inGameUI.json');
